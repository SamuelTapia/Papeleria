...
<head>
    <meta charset="UTF-8">
    <title>Proveedores | Papelerias Grafito´s Co.</title>
...
<body>
    ...
    <nav class="main-nav">
        <div class="container container--flex">
            ...
            <ul class="menu" id="menu">
                ...
                <li class="menu__item"><a href="proveedores.php" class="menu__link menu__link--select">Proveedores</a></li>
    ...
    <section class="banner">
        <img src="img/fondo13.jpg" alt="" class="banner__img">
            ...
            <div class="container container--flex"> 
                    ...
                    <section class="group group--color">
                        ...
                        <div class="tabla">
                                ...
                                <?php
                                                $consulta = "select razon_social,nombre, ap_paterno,ap_materno,telefono,estado,calle, cp,colonia,numero from proveedor as pro join telefono as tel on pro.razon_social=tel.razon_social_proveedor";
