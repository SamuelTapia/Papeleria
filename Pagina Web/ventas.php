...
<head>
    <meta charset="UTF-8">
    <title>Ventas | Papelerias Grafito´s Co.</title>
...
<body>
    ...
    <nav class="main-nav">
        <div class="container container--flex">
            ...
            <ul class="menu" id="menu">
                ...
                <li class="menu__item"><a href="ventas.php" class="menu__link menu__link--select">Ventas</a></li>
    ...
    <section class="banner">
        <img src="img/fondo12.jpg" alt="" class="banner__img">
            ...
            <div class="container container--flex"> 
                <p style= "line-height: 30px; text-align: center" class="main__txt">
                    ...
                    <div class="tabla">
                                ...
                                <?php
                                                $consulta = "select fecha,num_venta,razon_social_cliente,descripcion,precio_art,cantidad_art,precio_total from ventas as ven join producto_vendido as pv on ven.num_venta=pv.num_venta_ventas join productos as prod on prod.cod_barras_inventario=pv.cod_barras_inventario";
